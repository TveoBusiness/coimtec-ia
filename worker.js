<!-- BOTÓN FLOTANTE DE WHATSAPP - TVEO BUSINESS -->
<a href="https://wa.me/message/PJBMLOLZEDVPF1" target="_blank" rel="noopener noreferrer" style="
    position: fixed;
    bottom: 25px;
    right: 25px;
...
" 
onmouseover="this.style.transform='scale(1.1)'; this.style.backgroundColor='#20ba5a';" 
onmouseout="this.style.transform='scale(1)'; this.style.backgroundColor='#25D366';"
title="¡Escríbenos por WhatsApp!">
    <!-- Ícono SVG oficial de WhatsApp -->
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 511.9" width="34" height="34" fill="currentColor">
